...
const static int dos_palette[256] = {
...
public:
    ...
    App(int w, int h, int s, const char* title);
    ...
    void    print(const char* msg, int x, int);
    void    saveframe();
};
